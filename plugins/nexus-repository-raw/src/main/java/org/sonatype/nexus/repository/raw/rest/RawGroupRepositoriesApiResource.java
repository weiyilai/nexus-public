...
import org.sonatype.nexus.repository.raw.RawGroupApiRepository;
...
{
  @ApiOperation("Create raw group repository")
  @ApiResponses(value = {
  ...
  @Path("/{repositoryName}")
  @Override
  @ApiOperation(value = "Get repository", response = RawGroupApiRepository.class)
