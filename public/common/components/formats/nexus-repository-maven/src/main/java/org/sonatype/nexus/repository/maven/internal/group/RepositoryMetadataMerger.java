    ...
    extends ComponentSupport
{
  ...
  public boolean metadataEquals(final Metadata md1, final Metadata md2) {
    checkNotNull(md1);
    checkNotNull(md2);
    return stringEquals(md1.getGroupId(), md2.getGroupId()) && // NOSONAR
  ...
  private boolean versioningEquals(
      @Nullable final Versioning v1,
      @Nullable final Versioning v2)
  { // NOSONAR
    if (v1 == null || v2 == null) {
      return v1 == v2; // NOSONAR
    }
    else {
      return stringEquals(v1.getLatest(), v2.getLatest()) && // NOSONAR
      ...
      @Nullable final Snapshot s2)
  {
    if (s1 == null || s2 == null) {
      ...
      return stringEquals(s1.getTimestamp(), s2.getTimestamp()) &&
  ...
  private boolean snapshotVersionEquals(final SnapshotVersion s1, final SnapshotVersion s2) {
    return stringEquals(s1.getClassifier(), s2.getClassifier()) && // NOSONAR
  ...
  private boolean pluginEquals(final Plugin p1, final Plugin p2) {
    return stringEquals(p1.getName(), p2.getName()) &&
