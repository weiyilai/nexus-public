...
public class Maven2Metadata
{
  ...
  public static class Snapshots
  {
    ...
    private Snapshots(
        @Nullable final Long snapshotTimestamp,
  ...
  public static Maven2Metadata newGroupLevel(
      final DateTime lastUpdated,
  ...
  public static Maven2Metadata newArtifactLevel(
      final DateTime lastUpdated,
  ...
  public static Maven2Metadata newVersionLevel(
      final DateTime lastUpdated,
      final String groupId,
      final String artifactId,
      final String version,
  ...
  public static Maven2Metadata newNonUniqueVersionLevel(
      final String groupId,
      final String artifactId,
      final String version)
  {
