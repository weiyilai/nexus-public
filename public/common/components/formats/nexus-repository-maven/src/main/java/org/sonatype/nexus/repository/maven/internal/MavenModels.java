...
public final class MavenModels
{
   ...
   */
  public static void writeMetadata(final OutputStream outputStream, final Metadata metadata) throws IOException {
   ...
   */
  @Nullable
  public static ArchetypeCatalog readArchetypeCatalog(final InputStream inputStream) throws IOException {
    try (InputStream is = inputStream) {
   ...
   */
  public static void writeArchetypeCatalog(
      final OutputStream outputStream,
      final ArchetypeCatalog archetypeCatalog) throws IOException
  {
