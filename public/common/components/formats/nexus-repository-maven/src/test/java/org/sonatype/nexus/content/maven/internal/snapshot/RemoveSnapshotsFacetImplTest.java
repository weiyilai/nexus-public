    ...
    extends TestSupport
{
  ...
  public void testGetSnapshotsToDelete_releaseNoSnapshotsOK() {
    verifyGetSnapshotsToDelete(config(), Collections.singletonList(component("1.0", 0, "1.0")),
        Collections.emptyList());
  }

  @Test
  public void testGetSnapshotsToDelete_minSnapshotCountOneDeletesFive() {
    verifyGetSnapshotsToDelete(config(1), testGavWithRelease,
  ...
  public void testGetSnapshotsToDelete_minSnapshotCountTwoDeletesFour() {
    verifyGetSnapshotsToDelete(config(2), testGavWithRelease,
        Arrays.asList("1.0-20160101.000001", "1.0-20160201.000001",
  ...
  public void testGetSnapshotsToDelete_removeIfReleasedNoGrace() {
    verifyGetSnapshotsToDelete(config(3, 0, true), testGavWithRelease,
        Arrays.asList("1.0-20160101.000001", "1.0-20160201.000001", "1.0-20160220.000001"));
  }

  @Test
  public void testGetSnapshotsToDelete_removeIfReleasedGraceTwo() {
    verifyGetSnapshotsToDelete(config(3, 0, true, 2), testGavWithRelease,
        Arrays.asList("1.0-20160101.000001", "1.0-20160201.000001", "1.0-20160220.000001"));
  }
  ...
  {
    List<String> snapshotsToDelete = removeSnapshotsFacet.getSnapshotsToDelete(config, components)
        .stream()
    ...
    if (expectedDeletions.isEmpty()) {
      ...
      assertThat(snapshotsToDelete,
          containsInAnyOrder(expectedDeletions.toArray(new String[expectedDeletions.size()])));
    }
  }
