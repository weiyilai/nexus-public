    ...
    extends TestSupport
{
  ...
  private static final InputStreamSupplier AUDIO_CAF_SUPPLIER =
      () -> new ByteArrayInputStream("caff123456789".getBytes());

  private static final InputStreamSupplier MD5_SUPPLIER =
      () -> new ByteArrayInputStream("0161dba22520b2c13b50493fd98ed4ce".getBytes());

  private static final InputStreamSupplier SHA1_SUPPLIER =
      () -> new ByteArrayInputStream("2abe58492ad5e25e18cfca3fad4f0322d47cb893".getBytes());

  private static final InputStreamSupplier SHA256_SUPPLIER =
      () -> new ByteArrayInputStream("34cbb64305cb610b642162b052e66b4683ae68fd20d34591c21ab68bec106ccb".getBytes());

  private static final InputStreamSupplier SHA512_SUPPLIER = () -> new ByteArrayInputStream(
      "bfe3bcd9fc7180c2439d7c0b3b3036f71a6da1fed2983e3ab23185bf3a6877f6a32dbd6b949d7ef3ab1935699a113f47987082fbaffb2ce9f65f5ad058475c0e"
          .getBytes());

  @Parameters(
      name = "{index}: contentName:{0} strictContentValidation:{1}, declaredContentType:{2}, contentSupplier:{3}")
  ...
  public void setUp() throws Exception {
    ...
    when(defaultContentValidator.determineContentType(eq(isStrictContentValidation),
        ...
        eq(mimeRulesSource),
        any(),
        eq(declaredMimeType))).thenReturn(TEXT_PLAIN.getMimeType());
  }
