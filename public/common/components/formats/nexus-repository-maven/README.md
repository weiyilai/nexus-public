...
```
Note: Maven group repositories do not use `versionPolicy`, `layoutPolicy`, or `contentDisposition` fields as they aggregate content from member repositories which have their own Maven-specific settings.
