...
{
  // Pattern extracted from <xs:simpleType name="cron-expressionType"> in
  // http://svn.terracotta.org/svn/quartz/trunk/quartz-core/src/main/resources/org/quartz/xml/job_scheduling_data_2_0.xsd
