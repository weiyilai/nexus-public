 ...
 *
 * When this class has no future, that means that task is in {@link TaskState.Group#WAITING} or
 * {@link TaskState.Group#DONE} states.
 *
 * @since 3.0
 */
    ...
    implements TaskInfo
{
  ...
  public synchronized void setNexusTaskState(
   ...
   */
  public synchronized void setNexusTaskStateIfWaiting(
      final QuartzTaskState taskState,
      @Nullable final QuartzTaskFuture taskFuture)
  {
    if (state.isWaiting()) {
