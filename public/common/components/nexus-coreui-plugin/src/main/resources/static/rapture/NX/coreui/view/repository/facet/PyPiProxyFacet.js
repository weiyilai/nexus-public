        ...
        items: [
          {
            ...
            value: false,
            disabled: true,
            fieldLabel: NX.I18n.get('Repository_Facet_Pypi_RemoveQuarantined_Label'),
            helpText: NX.I18n.get('Repository_Facet_Pypi_RemoveQuarantined_HelpText')
          },
          {
            xtype: 'panel',
            name: 'pypiProxyFirewallWarning',
            itemId: 'warning',
            ui: 'nx-drilldown-message',
            cls: 'nx-drilldown-warning',
            iconCls: NX.Icons.cls('drilldown-warning', 'x16'),
            title: NX.I18n.format('Repository_Facet_Pypi_RemoveQuarantined_Warning_Default'),
            hidden: false
          }
        ]
      }
