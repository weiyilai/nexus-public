...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    SearchSwift_Description: 'Search for components in Swift repositories',
    ...
    Repository_RepositoryFeature_HealthCheckDisable_Button: 'Disable SystemStatus',
    Repository_RepositoryFeature_HealthCheckEnable_Button: 'Enable SystemStatus',
    ...
    Repository_Facet_Docker_PathEnabled_FieldLabel: '<strong>Path based routing</strong>',
    Repository_Facet_Docker_PathEnabled_HelpText:
        '<span style="color:#333;font-size:10px;">Use the following URL with your Docker client to pull images from this repository:<br><em>company.com/<strong>{{repoName}}</strong>/image:tag</em></span>',
    Repository_Facet_Docker_PathEnabled_WarningText: 
        'Switching to path based routing will remove any previously configured subdomain or port connectors.',
    Repository_Facet_Docker_Subdomain_FieldLabel: 'Subdomain Routing',
    Repository_Facet_Docker_OtherConnectors_FieldLabel: '<strong>Other Connectors</strong>',
    Repository_Facet_Docker_OtherConnectors_HelpText: '<span style="color:#333;font-size:10px;">Select subdomain, ports, or leave blank if using a reverse proxy.</span>',
    ...
    Repository_Facet_TerraformFacet_Title: 'Terraform Settings',
    ...
    Repository_Facet_Npm_RemoveQuarantined_Warning_Default: 'To use this feature, enable Repository Firewall Audit and Quarantine capability with the Enable Quarantine checkbox selected. This feature requires IQ Server Release 134 or higher.',
    ...
    Repository_Facet_Pypi_RemoveQuarantined_Warning_Default: 'To use this feature, enable Repository Firewall Audit and Quarantine capability with the Enable Quarantine checkbox selected. This feature requires IQ Server Release 167 or higher.',
    ...
    Task_TaskScope_Duration_FieldHelpText: 'Limit how far back the task checks for added or deleted files.',
