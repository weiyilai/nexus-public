...
public final class NexusSecurityApiConstants
{
  ...
  public static final String FIRST_NAME_DESCRIPTION = "The first name of the user.";

  public static final String LAST_NAME_DESCRIPTION = "The last name of the user.";

  public static final String EMAIL_DESCRIPTION = "The email address associated with the user.";

  public static final String STATUS_DESCRIPTION = "The user's status, e.g. active or disabled.";
  ...
  public static final String ROLES_DESCRIPTION = "The roles which the user has been assigned within Nexus.";
  ...
  public static final String PRIVILEGE_READONLY_DESCRIPTION =
      "Indicates whether the privilege can be changed. External values supplied to this will be ignored by the system.";

  public static final String PRIVILEGE_DOMAIN_DESCRIPTION =
      "The domain (i.e. 'blobstores', 'capabilities' or even '*' for all) that this privilege is granting access to."
          + "  Note that creating new privileges with a domain is only necessary when using plugins that define their own domain(s).";

  public static final String PRIVILEGE_REPOSITORY_FORMAT_DESCRIPTION =
      "The repository format (i.e 'nuget', 'npm') this privilege will grant access to (or * for all).";

  public static final String PRIVILEGE_REPOSITORY_DESCRIPTION =
      "The name of the repository this privilege will grant access to (or * for all).";

  public static final String PRIVILEGE_CONTENT_SELECTOR_DESCRIPTION =
  ...
  public static final String PRIVILEGE_PATTERN_DESCRIPTION =
      "A colon separated list of parts that create a permission string.";

  public static final String PRIVILEGE_ACTION_DESCRIPTION =
  ...
  public static final String ROLE_READONLY_DESCRIPTION =
