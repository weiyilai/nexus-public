    ...
    extends TestSupport
{
  ...
  private void verifyMergeMultipleContents(
      Function<List<InputStreamSupplier>, NestedAttributesMap> function) throws IOException
  {
  ...
  private void verifyMergingMultipleContentsWithMultiDepthJson(
      Function<List<InputStreamSupplier>, NestedAttributesMap> function) throws IOException
  {
