...
public class VersionNumberExpanderTest
{
  ...
  public void mixedText() {
    ...
    assertEquals("beta-000000001.000000023-alpha000000004-snapshot",
        VersionNumberExpander.expand("beta-1.23-alpha4-snapshot"));
  }

  @Test
  public void longNumber() {
    assertEquals("v000000001-rev020181217-000000001.000000027.0123456789123456789123456789",
        VersionNumberExpander.expand("v1-rev20181217-1.27.0123456789123456789123456789"));
  }
}
