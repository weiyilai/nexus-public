...
public interface RoutingRulesApiResourceDoc
{
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(code = 400,
          message = "A routing rule with the same name already exists or required parameters missing"),
      @ApiResponse(code = 403, message = "Insufficient permissions to create routing rule")
  })
  void createRoutingRule(
      @ApiParam(value = "A routing rule configuration", required = true) @NotNull RoutingRuleXO routingRuleXO);
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(code = 400,
          message = "Another routing rule with the same name already exists or required parameters missing"),
  ...
  void updateRoutingRule(
      ...
      @ApiParam(value = "A routing rule configuration", required = true) @NotNull final RoutingRuleXO routingRuleXO);
  ...
  void deleteRoutingRule(
      @ApiParam(value = "The name of the routing rule to delete", required = true) final String name);
}
