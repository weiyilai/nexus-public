    ...
    extends UntypedObjectDeserializer
{
  ...
  protected final Object defaultDeserialize(
      ...
      final DeserializationContext context) throws IOException
  {
    ...
    // Depending on whether we are not in an array, this will return null, returning null will prevent high memory
    // usage.
    return value;
  }

  protected final Object defaultValueDeserialize(
      final JsonParser parser,
      final DeserializationContext context) throws IOException
  {
    // rely on the real deserialization of jackson's own deserializer
