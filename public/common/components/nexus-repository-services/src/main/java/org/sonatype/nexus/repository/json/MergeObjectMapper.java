...
public class MergeObjectMapper
{
   ...
   */
  public NestedAttributesMap merge(
      final List<InputStreamSupplier> inputStreams,
      @Nullable final Charset charset) throws IOException
  {
  ...
  protected void deserialize(
      final NestedAttributesMapJsonParser parser,
      ...
      extends ObjectMapper
  {
    ...
    private NestedAttributesMap merge(
        final List<InputStreamSupplier> inputStreams,
        @Nullable final Charset charset) throws IOException
    {
    ...
    private NestedAttributesMapJsonParser createParser(
        final NestedAttributesMap result,
        final InputStream inputStream,
        @Nullable final Charset charset) throws IOException
    {
