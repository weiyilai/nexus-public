    ...
    implements HttpDefaultsCustomizer
{
  ...
  public DefaultsCustomizer(
      ...
      @Value("${nexus.httpclient.connectionRequestTimeout:30s}") final Time connectionRequestTimeout,
      @Value("${nexus.httpclient.keepAliveDuration:30s}") final Time keepAliveDuration,
      @Value("${nexus.httpclient.bufferSize:8k}") final ByteSize bufferSize,
      @Value("${nexus.httpclient.retryCount:2}") final int retryCount)
  {
