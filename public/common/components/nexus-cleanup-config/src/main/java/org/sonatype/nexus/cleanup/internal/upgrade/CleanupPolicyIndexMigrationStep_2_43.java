...
/**
 * Adds index to cleanup_policy table for existing databases.
 *
...
public class CleanupPolicyIndexMigrationStep_2_43
    implements DatabaseMigrationStep
{
  ...
  public Optional<String> version() {
    return Optional.of("2.43");
  }

  @Override
  public void migrate(final Connection connection) throws Exception {
    if (tableExists(connection, TABLE_NAME)) {
      createIndexIfNotExists(connection, "idx_cleanup_policy_format",
          TABLE_NAME, "format");
    }
  }
