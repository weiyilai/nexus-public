...
/**
 * Adds index to privilege table for existing databases.
 *
...
public class PrivilegeIndexMigrationStep_2_46
    implements DatabaseMigrationStep
{
  private static final String TABLE_NAME = "privilege";

  @Override
  public Optional<String> version() {
    return Optional.of("2.46");
  }

  @Override
  public void migrate(final Connection connection) throws Exception {
    if (tableExists(connection, TABLE_NAME)) {
      createIndexIfNotExists(connection, "idx_privilege_by_name",
          TABLE_NAME, "name");
    }
  }
