 ...
 */
package org.sonatype.nexus.internal.security.model.upgrade;
...
/**
 * Adds index to user_role_mapping table for existing databases.
 *
...
public class UserRoleMappingIndexMigrationStep_2_45
    implements DatabaseMigrationStep
{
  private static final String TABLE_NAME = "user_role_mapping";

  @Override
  public Optional<String> version() {
    return Optional.of("2.45");
  }

  @Override
  public void migrate(final Connection connection) throws Exception {
    if (tableExists(connection, TABLE_NAME)) {
      createIndexIfNotExists(connection, "idx_user_role_mapping_source",
          TABLE_NAME, "user_lo, source");
    }
  }
