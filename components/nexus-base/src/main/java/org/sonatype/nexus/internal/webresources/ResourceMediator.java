...
public class ResourceMediator
    extends MediatorSupport<WebResource>
{
  private final WebResourceServiceImpl watcher;

  @Inject
  public ResourceMediator(final WebResourceServiceImpl watcher) {
    super(WebResource.class);
    this.watcher = checkNotNull(watcher);
  }

  @Override
  protected void add(final WebResource entry) {
    watcher.addResource(entry);
  }
}
