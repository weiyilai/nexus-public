 ...
 */
package org.sonatype.nexus.extender.guice.listeners;
...
/**
 * !!!! DEPRECATED This annotation processor needs a new implementation in spring (only load for
 * `nexus.spring.only=true`,
