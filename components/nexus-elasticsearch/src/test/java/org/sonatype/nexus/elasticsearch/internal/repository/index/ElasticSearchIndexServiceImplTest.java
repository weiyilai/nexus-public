...
import org.sonatype.nexus.elasticsearch.internal.repository.query.ElasticSearchQueryServiceImpl;
    ...
    extends TestSupport
{
  ...
  protected Repository repository(final String name) throws Exception {
      ...
      extends RepositoryImpl
  {
    ...
    public TestRepository(final EventManager eventManager, final Type type, final Format format) {
