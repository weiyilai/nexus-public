...
/**
 * "attributes.nuget.title" {@link ElasticSearchContribution} (adds a match query for title).
 */
@Component
@Qualifier("assets.attributes.nuget.title")
@Singleton
@ConditionalOnProperty(name = ELASTIC_SEARCH_ENABLED, havingValue = "true", matchIfMissing = true)
public class NugetTitleElasticSearchContribution
