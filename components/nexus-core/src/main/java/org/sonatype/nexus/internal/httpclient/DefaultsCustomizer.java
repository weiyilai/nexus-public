    ...
    implements HttpDefaultsCustomizer
{
  ...
  public DefaultsCustomizer(
      ...
      @Named("${nexus.httpclient.requestTimeout:-20s}") @Value("${nexus.httpclient.requestTimeout:20s}") final Time requestTimeout,
      @Named("${nexus.httpclient.connectionRequestTimeout:-30s}") @Value("${nexus.httpclient.connectionRequestTimeout:30s}") final Time connectionRequestTimeout,
      @Named("${nexus.httpclient.keepAliveDuration:-30s}") @Value("${nexus.httpclient.keepAliveDuration:30s}") final Time keepAliveDuration,
      @Named("${nexus.httpclient.bufferSize:-8k}") @Value("${nexus.httpclient.bufferSize:8k}") final ByteSize bufferSize,
      @Named("${nexus.httpclient.retryCount:-2}") @Value("${nexus.httpclient.retryCount:2}") final int retryCount)
  {
