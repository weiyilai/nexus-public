...
/**
 * TODO: this class doesn't actually run after moving to this package. Confirmed with product that we can drop this h2
 * 1.4->2.2 upgrade tool.
 * If we do go ahead with this idea, we will need to make a ticket to just remove this class.
 */
@Deprecated
@Component
@Singleton
